...
// paths : 扇形／片狀肌肉可改用多股走行（來源解剖資料未收錄、只能以示意幾何表示的肌肉才需要）
// r     : 肌腹最大半徑（公尺）
// deep  : 深層肌，顯示時較透明
...
export const MUSCLES = {
  ...
  temporalis: {
    ...
    // 來源解剖資料未收錄，改用三股扇形示意：由顳窩收束到下頜骨喙突
    paths: [
      [[0.070, 1.706, 0.028], [0.080, 1.660, 0.034], [0.072, 1.622, 0.032]],
      [[0.080, 1.700, 0.004], [0.086, 1.658, 0.024], [0.073, 1.622, 0.032]],
      [[0.078, 1.688, -0.020], [0.086, 1.652, 0.010], [0.074, 1.622, 0.032]],
    ], r: 0.009,
  ...
  latissimus: {
    ...
    // 來源解剖資料未收錄，改用五股扇形示意：由 T7–L5 棘突與髂嵴收束到肱骨結節間溝
    paths: [
      [[0.014, 1.240, -0.092], [0.080, 1.290, -0.078], [0.150, 1.330, -0.040], [0.184, 1.362, -0.006]],
      [[0.016, 1.160, -0.090], [0.085, 1.235, -0.078], [0.152, 1.320, -0.040], [0.184, 1.360, -0.006]],
      [[0.018, 1.080, -0.084], [0.090, 1.180, -0.076], [0.154, 1.310, -0.040], [0.184, 1.358, -0.006]],
      [[0.020, 1.000, -0.080], [0.095, 1.130, -0.074], [0.156, 1.300, -0.040], [0.184, 1.356, -0.006]],
      [[0.060, 0.960, -0.072], [0.110, 1.090, -0.068], [0.158, 1.290, -0.040], [0.184, 1.354, -0.006]],
    ], r: 0.011,
  ...
  rectus_abdominis: {
    ...
    path: [[0.032, 1.186, 0.092], [0.034, 1.130, 0.095], [0.034, 1.062, 0.095], [0.033, 1.000, 0.092], [0.032, 0.940, 0.084]], r: 0.021,
